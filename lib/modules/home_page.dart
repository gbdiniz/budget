          ...
          return Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  decoration: InputDecoration(labelText: 'Histórico'),
    ...
    setState(() {
      database.insert(
        'tabela',
        {
          ...
          'entrada': !isRetrive ? double.parse(quantityController.text) : 0,
          'saida': !isRetrive ? 0 : double.parse(quantityController.text)
        },
      );
    });
    _select();
                  ...
                  Stack(
                    children: [
                      ...
                      Container(
                        ...
                        height: tabela.isEmpty ? 100 : null,
